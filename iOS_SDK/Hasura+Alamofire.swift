...
//    
//    @discardableResult
//    public static func request<T: JSONParsable>(
//        url: String,
//        httpMethod: HTTPMethod = .get,
//        requestBody: T? = nil,
//        headers: HTTPHeaders? = nil
//        ) -> HasuraDataRequest {
//        
//        return HTTPManager.request(url: url, httpMethod: httpMethod, params: (requestBody != nil ? requestBody?.toJSON() : nil), headers: headers)
//        
//    }
//    
//    @discardableResult
...
//        
//        return HasuraDownloadFileRequest(downloadRequest: Alamofire.download(url, method: .get, headers: headers))
//        
//        
//    }
//    
